      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-backgroundColor">
            Register as Recycling Industry
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Join MediClean's Recycling Network
          </p>
        </div>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <div className="space-y-2">
                {["Plastic", "Glass", "Metal", "Organic", "Chemical"].map((type) => (
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-gray-600">
            ...
            <button
              onClick={() => navigate('/recycler-signin')}
...
export default RecyclerRegisterPage; 